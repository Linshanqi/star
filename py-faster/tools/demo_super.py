...
def vis_detections(im, class_name, dets, image_name, ax,thresh=0.1):
...
def demo(net, image_name):
    ...
    for cls_ind, cls in enumerate(CLASSES[1:]):
        ...
        dets = dets[keep, :]
        vis_detections(im, cls, dets, image_name, ax,thresh=CONF_THRESH)
    plt.axis('off')
    ...
    # plt.tight_layout()
    plt.draw()
    plt.savefig("./data/demo/tese22/" + im_name,dpi=300)
def parse_args():
