...
global CLASSES
global NETS
INPUT_FILE = "/home/shelly/video_for_test_ApplePests62.mp4"
OUTPUT_FILE = '/home/shelly/liang.avi'
CONF_THRESH = 0.5
NMS_THRESH = 0.001

CLASSES = ('__background__',
           'Alternaria_Leaf_Spot', 'Brown_Spot' ,'Gray_Spot','Rust','Mosaic')
...
while(cap.isOpened()):
	...
	timer.toc()
	RESULT_FPS = 1. // timer.total_time
	with open("/home/shelly/liang","a") as f:  ##以追加方式打开文件，存放fps值
		f.write(str(RESULT_FPS)+"\n")
        out.write(frame)
